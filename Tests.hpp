...
{
    cout<< "###########- Проверочные тесты DynamicArray_##########"<<endl;
    
    int t[]={2,5,3,7,5,8,9,8,9,1};
    ...
    cout<< "###########- Тесты DynamicArray пройдены - ok! ##########"<<endl;
...
int TestLinkedList()
{
    cout<< "###########- Проверочные тесты LinkedList_##########"<<endl;
    ...
    cout<< "###########- Тесты LinkedList пройдены - ok! ##########"<<endl;
    return 0;
}
/*
...
int TestArraySequence()
{
    ...
    cout<< "###########- Проверочные тесты ArraySequence _##########"<<endl;
    ...
    cout<< "###########- Тесты ArraySequence пройдены - ok! ##########"<<endl;
    return erors;
}
